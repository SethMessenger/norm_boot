 ...
 * @desc    客户端判断工具
 * TODO     仍然需要将类中的静态描述信息转化为枚举来进行使用
 */
public class HttpUtils {

    /**
     * @author  SethMessenger
     * @desc    Wap网关Via头信息中特有的描述信息
     */
    private enum mobileGateWayHeadersEnum{

        DEBUG_VIA("myvia","自配个人debug网关"),
        ZHONGXING_VIA("ZXWAP","中兴提供的wap网关的via信息，例如：Via=ZXWAP GateWayZTE Technologies"),
        NOKIA_VIA("chinamobile.com","中国移动的诺基亚wap网关，例如：Via=WTP/1.1 GDSZ-PB-GW003-WAP07.gd.chinamobile.com (Nokia WAP Gateway 4.1 CD1/ECD13_D/4.1.04)"),
        MENGWANG_VIA("monternet.com","移动梦网的网关，例如：Via=WTP/1.1 BJBJ-PS-WAP1-GW08.bj1.monternet.com. (Nokia WAP Gateway 4.1 CD1/ECD13_E/4.1.05)"),
        HUAWEI_VIA("infoX","华为提供的wap网关，例如：Via=HTTP/1.1 GDGZ-PS-GW011-WAP2 (infoX-WISG Huawei Technologies)，或Via=infoX WAP Gateway V300R001 Huawei Technologies"),
        FOREIGN_VIA1("XMS 724Solutions HTG","国外电信运营商的wap网关，不知道是哪一家"),
        UNKOWN_VIA1("Bytemobile","貌似是一个给移动互联网提供解决方案提高网络运行效率的，例如：Via=1.1 Bytemobile OSN WebProxy/5.1");
        ...
        private mobileGateWayHeadersEnum(){}
        private mobileGateWayHeadersEnum(String headerName, String desc) {
