...
//			try {
//				SpringUtils.applicationContext = new ClassPathXmlApplicationContext(configLocations);
//			} catch (BeansException beansException) {
//				logger.error("SpringUtils[创建应用上下文环境出错]", beansException);
//			}
//		}
//	}
//
