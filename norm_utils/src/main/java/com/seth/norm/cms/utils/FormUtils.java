...
public class FormUtils {
    ...
    public static void main(String[] args) {
        String s = "" + null;
//        System.out.println("过滤中英文特殊字符: "+FormUtils.stringFilter("中国~~!#$%%."));
//        System.out.println("是否包含中英文特殊字符: "+FormUtils.isContainsSpecialChar("12"));
//        System.out.println("过滤html代码: "+FormUtils.htmltoText("<JAVASCRIPT>12</JAVASCRIPT>DDDDD"));
//        System.out.println("判断中文字符: "+FormUtils.isChineseChar("中国！"));
        System.out.println("匹配汉字: "+FormUtils.isChinese("中国！"));
//        System.out.println("判断英文字符: "+FormUtils.isEnglish("abc!"));
//        System.out.println("判断合法字符: "+FormUtils.isRightfulString("abc_-11AAA"));
//        System.out.println("邮政编码验证: "+FormUtils.isZipCode("162406"));
//        System.out.println("身份证号码验证: "+FormUtils.isIdCardNo("35052419880210133e"));
//        System.out.println("手机号码验证: "+FormUtils.isMobile("18918611111"));
//        System.out.println("电话号码验证: "+FormUtils.isPhone("8889333"));
//        System.out.println("电话号码验证: "+FormUtils.isNumeric("888.9333"));
//        System.out.println("匹配密码: "+FormUtils.isPwd("d888d_ddddd"));
//        System.out.println("匹配密码: "+FormUtils.isUrl("http://baidu.com"));
        System.out.println("验证字符: "+FormUtils.stringCheck("中文aabc001_-"));
...
//        System.out.println(NumberUtils.toInt("-0000000002"));
     ...
     * @return
     */
    public final static boolean isHttpUrl(String str) {
     ...
     * @return
     */
    public final static boolean isHttpsUrl(String str) {
        return match(str, "^http://([\\w-]+\\.)+[\\w-]+(/[\\w-./?%&=]*)?$");
    }
